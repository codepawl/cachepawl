...
\begin{tikzpicture}[
    ...
    pthdr/.style={ptrow, font=\scriptsize\bfseries, align=center,
                  fill=gray!15},
    pcell/.style={draw, minimum width=2.3mm, minimum height=3.4mm,
                  inner sep=0pt, font=\tiny, fill=white},
    bcell/.style={draw, minimum width=5mm, minimum height=4.4mm,
                  inner sep=0pt, font=\tiny, fill=white},
  ...
  \node[pcell] (kvp0) at ([xshift=1.5mm, yshift=2.5mm] pthdr.east) {p0};
  ...
  \node[font=\tiny, right=0.2mm of kvp4] (kvdots) {$\cdots$};
  \node[pcell, right=0.2mm of kvdots, fill=kvblue!35] (kvp7) {p7};
  ...
  \node[bcell] (ssmb0) at ([xshift=1.5mm, yshift=-2mm] r2.east) {b0};
...
\begin{tikzpicture}[
  ...
  \node[state, below left=14mm and 1mm of B] (KP) {KV\_PRESSURED};
  \node[state, below right=14mm and 1mm of B] (SP) {SSM\_PRESSURED};
