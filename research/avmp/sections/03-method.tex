...
\begin{tikzpicture}[
    ...
    bcell/.style={draw, minimum width=5mm, minimum height=4.4mm,
                  inner sep=0pt, font=\tiny, fill=white},
    kvarrow/.style={->, line width=0.9pt, kvblue},
    ssmarrow/.style={->, line width=0.9pt, ssmorange},
  ...
  \node[bitbox, minimum width=2.5mm, below=1mm of hsub.south,
        xshift=-4.5mm] (pool) {\texttt{p}};
  \node[bitbox, minimum width=8.5mm, right=0pt of pool]
        (page) {\texttt{page\_id}};
