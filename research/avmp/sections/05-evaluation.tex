...
\caption{Cross-workload OOM and fragmentation baseline comparison.}
...
\caption{Final out-of-memory occurrence comparison across allocator variants.}
...
\caption{Per-workload goodput comparison between AVMP and best static baseline.}
...
\caption{OOM occurrence variance across different migration batch sizes.}
...
\caption{Stage 1 migration batch size sweep: per-workload OOM distribution across 9 batch sizes.}
...
\caption{Threshold sensitivity analysis showing marginal effect on OOM events.}
...
\caption{Peak reserved VRAM trade-off for dynamic allocation.}
...
Third, our evaluation uses synthetic prompt distributions. While our three presets successfully capture short, long, and bursty axes, they do not replicate real model traffic semantics. Future evaluations require ShareGPT and Alpaca traces.
