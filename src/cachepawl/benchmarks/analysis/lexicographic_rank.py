...
def _row_from_dict(row: object) -> AggregatedRow:
    ...
    return AggregatedRow(
        ...
        time_in_service_ns_median=int(row.get("time_in_service_ns_median", 0)),
        time_in_oom_retry_ns_median=int(row.get("time_in_oom_retry_ns_median", 0)),
        time_in_migration_ns_median=int(row.get("time_in_migration_ns_median", 0)),
        time_in_idle_ns_median=int(row.get("time_in_idle_ns_median", 0)),
